...
function AddTrip() {
    ...
    const { data: updateTrip } = useQuery("updatetrips", async () => {
    ...
    const handleOnSubmit = useMutation(async (e) => {
        try {
            ...
            const response = await API.patch('/trip', formData, config, trip)
            ...
            <Container className="w-50 fw-bold bg-light rounded-2 mt-3">
                ...
                <Form className="mx-5 text-start" onSubmit={(e) => handleOnSubmit.mutate(e)}>
                    ...
                    <Form.Group className="mb-3" controlId="formGridPassword" >
                        ...
                        <Form.Control name="acomodation" type="text" placeholder="Acomodation" style={{ backgroundColor: "#E5E5E5" }} onChange={handleChange} value={updateTrip?.acomodation} />
                    </Form.Group>updateTrip
